...
Status::Status():devid(0),displaymod(0),displaysensor(0),ptzpanspeed(0),ptztitlespeed(0),ptzpanodirection(0),ptztitledirection(0),workmode(-1),mouseevent(-1),mousex(-1),mousey(-1),mousemod(-1),
	storegonum(0),storemod(-1),storesavenum(0),storesavemod(0),displayresolution(-1),correctyear(-1),correctmonth(-1),
	correctday(-1),correcthour(-1),correctmin(-1),correctsec(-1),detectareanum(-1),detectareaenable(-1),movdetectenable(1),
