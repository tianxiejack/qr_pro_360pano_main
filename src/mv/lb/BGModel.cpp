...
namespace lb_library
{
  ...
  {
    m_SrcImage = cvCreateImage(cvSize(m_width, m_height), IPL_DEPTH_8U, 1);
    m_BGImage = cvCreateImage(cvSize(m_width, m_height), IPL_DEPTH_8U, 1);
    m_FGImage = cvCreateImage(cvSize(m_width, m_height), IPL_DEPTH_8U, 1);
